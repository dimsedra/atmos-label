...
import { ArrowLeft, Disc, Pause, Play, Sparkles, User, Users } from 'lucide-react';
import { GROUPS, MEMBERS, DISCOGRAPHY } from '../../../data/roster';

export default function RosterSlugPage() {
  const params = useParams();
  const slug = params?.slug as string;

  const [playingTrack, setPlayingTrack] = useState<string | null>(null);

  // Match member or group
  ...
  // MEMBER DETAIL VIEW
  if (member) {
    const memberGroup = GROUPS.find((g) => g.id === member.groupId);
